...
function useStarkAddress({
  ...
  return useQuery({
    queryKey: queryKey5({ name, contract }),
    queryFn: queryFn5({ name, contract, provider }),
    enabled,
    ...props
  });
}
function queryKey5({ name, contract }) {
  return [{ entity: "addressFromStarkName", name, contract }];
}
function queryFn5({
  name,
  contract,
