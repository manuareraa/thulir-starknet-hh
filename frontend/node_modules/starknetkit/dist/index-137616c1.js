...
var rn = (t, e, r) => e in t ? tn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var ie = (t, e, r) => (rn(t, typeof e != "symbol" ? e + "" : e, r), r);
import { g as sr, c as je, C as nn, a as ye, b as Mt, U as $t, d as sn } from "./connector-ca2f4153.js";
import { constants as an, Account as on, SequencerProvider as cn } from "starknet";
const ir = "https://web.argent.xyz", Dt = `<svg
    width="32"
    height="28"
    viewBox="0 0 18 14"
    fill="none"
...
const Tt = (t) => mr(t, []), Et = (t) => new Proxy(hr, {
  get(e, r) {
...
const Wt = typeof window > "u" || "Deno" in window || globalThis.process?.env?.NODE_ENV === "test" || !!globalThis.process?.env?.JEST_WORKER_ID || !!globalThis.process?.env?.VITEST_WORKER_ID;
function qt(t) {
  const e = t;
...
function Gn() {
  return function(e) {
    ...
    if (!(e?.isServer ?? Wt) && e?.allowOutsideOfServer !== !0)
...
const Xn = /* @__PURE__ */ sr(wn);
var q = {}, Kn = me;
const Bt = (t) => typeof t == "function";
function Tr(t) {
  if (t)
    return t;
...
function ws(t) {
  ...
  function jt() {
    ...
    return P.addEventListener("message", ({ data: I }) => {
      ...
      "method" in k ? se(k) : ct(k), (P !== h || m === "closed") && j(P);
      ...
      for (const [k, V] of Object.entries(o))
        if (V.ws === P) {
          ...
          V.type === "subscription" ? It(V) : (delete o[k], V.callbacks.error?.(Lr.TRPCClientError.from(new Ot("WebSocket closed prematurely"))));
        }
    }), P;
  }
  function At(R, P) {
    const { type: se, input: ct, path: I, id: k } = R, V = {
      id: k,
      method: se,
      params: {
        input: ct,
    ...
    return o[k] = {
      ...
      const Kr = o[k]?.callbacks;
      delete o[k], a = a.filter((en) => en.id !== k), Kr?.complete?.(), h.readyState === r.OPEN && R.type === "subscription" && (a.push({
        id: k,
...
var Yt = he, Ir = kt, jr = me, Qt = Xn, be = q, Ar = Ct, Pt = tt, Ts = Rt, Mr = rt;
class nt {
  $request({ type: e, input: r, path: n, context: s = {} }) {
...
}, Ms = Ar.createHTTPBatchLink(As), $s = (t) => {
  if ("input" in t) {
...
const ei = pe, ti = (t) => (0, ei.createBaseLink)({
  postMessage(e) {
...
it.popupLink = ai;
(function(t) {
  var e = je && je.__createBinding || (Object.create ? function(n, s, i, a) {
    a === void 0 && (a = i);
  ...
  }), r = je && je.__exportStar || function(n, s) {
    for (var i in n)
      i !== "default" && !Object.prototype.hasOwnProperty.call(s, i) && e(s, n, i);
  };
  Object.defineProperty(t, "__esModule", { value: !0 }), r(Ke, t), r(st, t), r(it, t);
})(yt);
var T;
(function(t) {
  t.assertEqual = (s) => s;
...
const _ = Object.freeze({
  status: "aborted"
}), zr = (t) => ({ status: "dirty", value: t }), N = (t) => ({ status: "valid", value: t }), _t = (t) => t.status === "aborted", bt = (t) => t.status === "dirty", ze = (t) => t.status === "valid", Ve = (t) => typeof Promise < "u" && t instanceof Promise;
var w;
(function(t) {
...
class C extends v {
  ...
  keyof() {
    return Vr(T.objectKeys(this.shape));
  }
}
C.create = (t, e) => new C({
  shape: () => t,
...
const De = (t) => t instanceof Pe ? De(t.schema) : t instanceof D ? De(t.innerType()) : t instanceof Se ? [t.value] : t instanceof Q ? t.options : t instanceof Ne ? Object.keys(t.enum) : t instanceof Le ? De(t._def.innerType) : t instanceof Ee ? [void 0] : t instanceof ke ? [null] : null;
class ot extends v {
  _parse(e) {
...
const Hr = (t, e = {}, r) => t ? de.create().superRefine((n, s) => {
  if (!t(n)) {
...
}) => Hr((r) => r instanceof t, e, !0), Fr = F.create, Jr = Y.create, bi = Ye.create, vi = xe.create, Gr = Te.create, wi = ee.create, xi = Be.create, Ti = Ee.create, Ei = ke.create, ki = de.create, Ci = K.create, Ri = J.create, Oi = He.create, Pi = $.create, Si = C.create, Ni = C.strictCreate, Li = Ce.create, Ii = ot.create, ji = Re.create, Ai = W.create, Mi = Oe.create, $i = Je.create, Di = te.create, Zi = ue.create, Ui = Pe.create, Wi = Se.create, qi = Q.create, zi = Ne.create, Vi = fe.create, er = D.create, Bi = H.create, Hi = re.create, Fi = D.createWithPreprocess, Ji = Ie.create, Gi = () => Fr().optional(), Yi = () => Jr().optional(), Qi = () => Gr().optional(), Xi = {
...
const Yr = /^0x[0-9a-f]+$/i, Qr = /^\d+$/, ea = f.string().nonempty("The short string cannot be empty").max(31, "The short string cannot exceed 31 characters").refine(
  (t) => !Yr.test(t),
...
}), ce = an.NetworkName, na = ce.SN_GOERLI;
function sa(t) {
  try {
...
const ia = 385, aa = 775, oa = 385, ca = 440, ua = 886, la = 562;
class nr {
  async getPubKey() {
...
const ha = async (t, e) => {
  ...
  const n = sa(t), s = new cn({ network: n });
  return fa(
    {
...
class ba extends nn {
  ...
  async ensureWallet() {
    ...
    ve({
      origin: r,
      location: "/interstitialLogin"
    }), A = await ha(r, ra({})) ?? null, this._wallet = A;
  }
}
export {
  ir as D,
